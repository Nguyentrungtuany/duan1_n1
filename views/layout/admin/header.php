...
SmartPhone Compatible web template, free WebDesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <!-- //font-awesome icons CSS-->
    <!-- side nav css file -->
    <link href="commons/css/SidebarNav.min.css" media="all" rel="stylesheet" type="text/css" />
    <!-- //side nav css file -->
    <!-- js-->
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="sidebar-menu">
                            ...
                            <li class="treeview">
                                ...
                                <ul class="treeview-menu">
                                    <li>
                                        <a href="?act=admin-list-user"><i class="fa fa-angle-right"></i> Quản Lý tài
                                            khoản</a>
                                    </li>
                                </ul>
                            ...
                            <li class="treeview">
                                <a href="?act=admin_guides">
                                    <i class="fa fa-table"></i> <span>Quản lý hướng dẫn viên</span>
                                    <i class="fa fa-angle-left pull-right"></i>
                                </a>
                                <ul class="treeview-menu">
                                    <li>
                                        <a href="?act=admin_guides"><i class="fa fa-angle-right"></i> Quản Lý hướng dẫn
                                            viên </a>
                                    </li>
                                </ul>
